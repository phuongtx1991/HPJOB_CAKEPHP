...
/**
 * DtbClasscategoryFixture
 *
 */
class DtbClasscategoryFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'dtb_classcategory';
    ...
    public $fields = [
        'classcategory_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['classcategory_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'rank' => 1,
            'creator_id' => 1,
            'create_date' => 1520507182,
            'update_date' => 1520507182,
            'del_flg' => 1
        ],
    ];
}
