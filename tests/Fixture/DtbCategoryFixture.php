 ...
 *
 */
class DtbCategoryFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'category_name' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'parent_category_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'rank' => 1,
            'creator_id' => 1,
            'create_date' => 1520507171,
            'update_date' => 1520507171,
            'del_flg' => 1
        ],
    ];
}
