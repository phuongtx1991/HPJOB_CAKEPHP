...
/**
 * DtbCategoryTotalCountFixture
 *
 */
class DtbCategoryTotalCountFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'dtb_category_total_count';
    ...
    public $fields = [
        ...
        'product_count' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
