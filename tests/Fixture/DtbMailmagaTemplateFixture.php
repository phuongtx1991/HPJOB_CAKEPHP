...
/**
 * DtbMailmagaTemplateFixture
 *
 */
class DtbMailmagaTemplateFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'dtb_mailmaga_template';
    ...
    public $fields = [
        ...
        'mail_method' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'del_flg' => 1,
            'creator_id' => 1,
            'create_date' => 1520507214,
            'update_date' => 1520507214
        ],
    ];
}
