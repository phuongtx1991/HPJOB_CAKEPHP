 ...
 *
 */
class DtbHolidayFixture extends TestFixture
{
    ...
    public $fields = [
        'holiday_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'title' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'month' => ['type' => 'smallinteger', 'length' => 6, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'day' => ['type' => 'smallinteger', 'length' => 6, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['holiday_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'rank' => 1,
            'creator_id' => 1,
            'create_date' => 1520507203,
            'update_date' => 1520507203,
            'del_flg' => 1
        ],
    ];
}
