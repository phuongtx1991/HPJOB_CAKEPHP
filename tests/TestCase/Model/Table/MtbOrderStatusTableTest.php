...
class MtbOrderStatusTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('MtbOrderStatus') ? [] : ['className' => MtbOrderStatusTable::class];
        $this->MtbOrderStatus = TableRegistry::get('MtbOrderStatus', $config);
    }
