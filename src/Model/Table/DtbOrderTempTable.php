 ...
 *
 * @method \App\Model\Entity\DtbOrderTemp get($primaryKey, $options = [])
 * @method \App\Model\Entity\DtbOrderTemp newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\DtbOrderTemp[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\DtbOrderTemp|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\DtbOrderTemp patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\DtbOrderTemp[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\DtbOrderTemp findOrCreate($search, callable $callback = null, $options = [])
 */
class DtbOrderTempTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('dtb_order_temp');
        $this->setDisplayField('order_temp_id');
        $this->setPrimaryKey('order_temp_id');
    ...
    public function validationDefault(Validator $validator)
    {
        $validator
            ...
            ->allowEmpty('order_temp_id', 'create');
        ...
        $validator
            ->allowEmpty('deliv_check');

        $validator
            ->allowEmpty('point_check');
